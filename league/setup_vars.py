...
pebbler_list = [
    ...
    {'name': 'Bload', 'description': 'Member of the Toad Brigade. A prodigy with sage insight who triumphed thrice on the Super Pebble Circuit.', 'isMale': True, 'trait': 'Speed', 'quirk': 'Pity Pebble', 'ability': 'Miracle'},
    ...
    {'name': 'Croc', 'description': 'Nephew to Ally. Loves to play hide and seek and can play both sides exceptionally.', 'isMale': True, 'trait': 'Skill', 'quirk': 'Even Temper', 'ability': 'Tip the Scales'},
    ...
    {'name': 'Ima Reddy', 'description': 'Lover to Dominic Bluey. A storied pebbler who won Pebbledon en route to the individual Super Pebble Circuit title.', 'isMale': False, 'trait': 'Power', 'quirk': 'Proud Pebble', 'ability': 'Miracle'},
    ...
    {'name': 'Watson', 'description': 'Member of the Bunny Bunch. What he lacks in youthfulness he makes up for with wisdom.', 'isMale': True, 'trait': 'Power', 'quirk': 'Pity Pebble', 'ability': 'Lucky Seven'},
    {'name': 'Yoad', 'description': 'Member of the Toad Brigade. While carefree and often sleeping on the job, he remains a valuable asset nonetheless.', 'isMale': True, 'trait': 'Speed', 'quirk': 'Pity Pebble', 'ability': 'Lucky Seven'},
]
